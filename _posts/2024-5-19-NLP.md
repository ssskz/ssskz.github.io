...
<img src="https://ssskz.github.io/materials/自然语言处理/1.png" width="30%">
...
```python
 ...
 tokenized=[]
 for article in peng(und token satanticles
    tokenized.append(word_tokenize(article))
```

<img src="https://ssskz.github.io/materials/自然语言处理/2.png" width="30%">
